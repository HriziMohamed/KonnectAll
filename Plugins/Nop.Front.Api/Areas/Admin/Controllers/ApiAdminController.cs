...
using Nop.Core;
using Nop.Front.Api.Areas.Admin.Models;
...
namespace Nop.Front.Api.Areas.Admin.Controllers
{
    [AuthorizeAdmin]
    [Area(AreaNames.Admin)]
    public class ApiFrontAdminController : BasePluginController
    {
        ...
        public ApiFrontAdminController(
        ...
        public async Task<IActionResult> Settings()
        {
            ...
            return View($"~/Plugins/Nop.Front.Api/Areas/Admin/Views/ApiAdmin/Settings.cshtml", model);
        }
