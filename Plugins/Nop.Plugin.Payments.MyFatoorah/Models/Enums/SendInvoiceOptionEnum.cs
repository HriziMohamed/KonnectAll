...
// Type: Nop.Plugin.Payments.MyFatoorah.Models.Enums.SendInvoiceOptionEnum
...
namespace Nop.Plugin.Payments.MyFatoorah.Models.Enums
{
  public enum SendInvoiceOptionEnum
  {
    SMS = 1,
    Email = 2,
    SMS_AND_EMAIL = 3,
